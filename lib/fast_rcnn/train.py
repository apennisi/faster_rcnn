...
class SolverWrapper(object):
    ...
    def train_model(self, sess, max_iters):
        ...
        if self.pretrained_model is not None:
            print('Loading pretrained model weights from %s ' % self.pretrained_model)
...
def get_training_roidb(imdb):
    ...
    if cfg.TRAIN.USE_EXPOSURE:
        print('Appending exposure changing training examples...')
        imdb.append_exposure_images()
        print('done')
